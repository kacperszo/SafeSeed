  ...
  <div className="bg-beige h-screen w-full font-mont flex flex-col">
   ...
   <div className="p-4">
    <h1 className="text-3xl font-quirky font-black text-deep-purple mb-4 w-4/5">
     Change your <span className="text-haps">username</span>
    </h1>
    <div
     className="border-2 rounded-lg text-lg border-katowice w-full flex
                justify-between items-center pl-4 "
    >
     {userData.nickname}
     <button
      type="button"
      onClick={async () => await nicknameMutate()}
   ...
   <div className="p-4">
    <h1 className="text-3xl font-quirky font-black text-deep-purple mb-3 w-4/5">
     Retake the signup <span className="text-haps">form</span>
    </h1>
    <div className="text-sm text-katowice font-medium w-4/5">
     Are you unhappy with your friend suggestions? You can retake the entry
     questionnaire to improve them&nbsp;:)
    </div>
   ...
   <div className="mt-auto flex justify-center pb-4">
    <button
     onClick={logout}
     className="transition hover:text-govtech font-bold"
    >
     Log out
    </button>
   </div>
